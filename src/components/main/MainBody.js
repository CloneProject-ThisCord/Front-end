...
const MainBody = () => {
  ...
  // const { isLoading, error, roomId, chatRoomList, chatRoom, chat, isSuccess } = useSelector(
  //   (state) => state.chat
  // );
  // const socket = new sockjs("http:///ws/chat"); //소켓연결하기위한 서버 url연결
  ...
  //       () => {
  //         stompClientws.unsubscribe("sub-0");
  //       },
  //       { token: token }
  //     );
  //   } catch (error) {
